...
try{
    ...
    header('Location: '.BASE_URL.'error404.php');
}
...
{
    $consulta = $conexion->prepare('
        SELECT prod.id, prod.nombre, prod.precio, prod.descripcion, prod.categoria_id, prod.imagen, cat.nombres categoria_nombre, prod.estrellas, prod.stock, prod.descuento
        FROM productos prod
